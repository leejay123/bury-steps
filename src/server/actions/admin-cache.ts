...
export async function resetSiteToDefault(
  ...
  try {
    await prisma.$transaction(async (tx) => {
      ...
      // One list for both branches of the upsert — two hand-copied lists
      // drifted apart before, leaving the About headings, the testimonials
      // eyebrow and the Progress switch as they were after a "reset".
      ...
      await tx.siteSetting.upsert({
        ...
        create: { id: SITE_SETTING_ID, ...starterSettings },
