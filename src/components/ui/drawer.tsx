...
// A click-to-close is 300ms. A fast swipe shortens that (strength × 300ms).
// Stay mounted a little past the longer of the two.
const DRAWER_CLOSE_ANIMATION_MS = 400;
