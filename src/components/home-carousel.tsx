...
export function HomeCarousel({
  ...
  // actually happened (see the effect above), so it's the real
  // readiness signal — `showControls` alone let this fire before Embla
  // had finished initializing and threw.
