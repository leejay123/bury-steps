...
/**
 * Open and close share one motion: transform only, 500ms,
 * cubic-bezier(0.4, 0, 0.2, 1). On a wide screen it comes in a third of
 * its width and leaves by travelling fully off, on that same timing.
